...
```bash
brew install jibankumarpanda/tap/gogcli
```
...
```bash
git clone https://github.com/jibankumarpanda/gogcli.git
cd gogcli
make
```
...
- `GOG_LIVE_EMAIL_TEST=jibankumarpanda+gogtest@gmail.com`
...
- [GitHub Repository](https://github.com/jibankumarpanda/gogcli)
