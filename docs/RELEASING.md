...
- `make` works locally.
- Access to the tap repo (e.g. `jibankumarpanda/homebrew-tap`).
...
brew untap jibankumarpanda/tap || true
brew tap jibankumarpanda/tap
brew install jibankumarpanda/tap/gogcli
brew test jibankumarpanda/tap/gogcli
